...
<div id="Contact-Me">
  ...
  <div className="footer-container">
      ...
      <div className="footer-content">
        ...
        <h3 className="footer-email">Email: 22024119-112@uog.edu.pk</p>

        {/* Social media icons */}
        <div className="social-icons">
          <img src="icon-facebook.png" alt="Facebook" className="icon" />
          <img src="icon-twitter.png" alt="Twitter" className="icon" />
          <img src="icon-instagram.png" alt="Instagram" className="icon" />
        </div>
      </div>
    </div>
