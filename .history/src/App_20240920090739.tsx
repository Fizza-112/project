  ...
  return (
    ...
    <div className="header-container">
      ...
      <div className="header-content">
        <h1 className="header-text">This is the Header Content</h1>
        <p className="sub-text">Add some more descriptive text here.</p>
      </div>
    ...
    <div className="header-container">
      <div><h1 className="header-text"><b>Hi All 👋 i'm <br/><span className="nam"> Fizza Tahir</span> </b> </h1>
      <div> <h2 id="contant">I do Code and<br/> make Contant <span className="span">About it!</span> </h2></div>
...
<h3 className='con'> Email: 22024119-112@uog.edu.pk</h3>
<div id="logo">
