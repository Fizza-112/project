...
const App = () => {
  return (
    ...
    <div className="header-container">
      ...
      {/* Anoether image (e.g., profile or other image) on th right side */}
      <img
...
<div className="div">
<div id="left-div">
  <img className="leftimgdiv"src={sidedivimg} alt="img" />
</div>
...
<li>Art</li>
  ...
  <div id="rightdiv">
  <img className="rightimgdiv"src={sidedivimg} alt="img" />
  </div>
  </div>
