  ...
  return (
    ...
    <div className="header-container">
      <div className="header-content">
        <h1 className="header-text">Your Header Content</h1>
      </div>
      <img
    ...
    <div className="header_container">
      <img src={marbelimg} alt="image"/>
      <div> <h1 id='name'><b>Hi All 👋 i'm <br/><span className="nam"> Fizza Tahir</span> </b> </h1>
    ...
    <div>
      <img  src={profimg} alt='image' id="image"/>
    </div>
    </header>
